    ...
    <div className="footer">
      <div className="container d-flex justify-content-between">
        ...
        <div className="footer__item">
            ...
            <div className="footer__contact">
                <img src={loc} alt="" />
                <div className="footer__val">27 Chashtepa ko'chasi, <br />
            ...
            <div className="footer__contact">
                <img src={mail} alt="" />
                <div className="footer__val">piruzofficial@gmail.com
            </div>
            </div>
        </div>
      </div>
      <div className="footer__bottom">
            <div className="container">
                    <div className="footer__copy">Pir.uz  -   © 2022 All Rights Reserved</div>
                    <a href="#" className="footer__author">Made with ♥ by Doin.uz</a>
            </div>
      </div>
    </div>
  );
